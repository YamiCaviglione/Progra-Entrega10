// pages/login.tsx
// Página de login que usa useLogin (React Query) con toasts y mensajes mejorados
...
export default function LoginPage() {
  ...
  const getErrorMessage = (errorText: string) => {
    ...
    if (!errorText || errorText === "Error en login" || errorText.length < 3) {
      return "No pudimos verificar tus credenciales. Verifica tu email y contraseña.";
    }
    return errorText;
  };
      ...
      <div className="max-w-md mx-auto mt-12 bg-white p-6 rounded-lg shadow-lg">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={login.isPending}
            className="w-full px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors font-medium"
          >
